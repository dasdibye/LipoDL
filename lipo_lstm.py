...
#Used to evaluate the prediction quality
def evaluation(model, X_test, y_test):
    ...
    ax.scatter( y_test[:400], prediction[:400],c='r', label="prediction_vs_original", linewidth=1.0)
    plt.legend()
...
#Create the training set using the sequence
